...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SupremeOverlord|HUD|Hints")
	FString ControlHintText = TEXT("LMB Move   |   RMB/Q Strike   |   E Shadow   |   R Drain   |   T Summon   |   Y Dismiss   |   C Trap   |   V Cycle   |   Z Overlord   |   U Resurrect   |   X Corpse   |   B Blink   |   H Curse   |   F1/2/3 Attrs   |   ESC Pause");
